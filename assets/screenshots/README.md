...
These are real interface captures, encoded as JPEG without retouching.

- `swt.jpg`: public landing page at https://stowarzyszenieswt.pl/, captured on 2026-09-05 with Browse, after dismissing optional cookies.
- `mrm.jpg`: existing portfolio capture, `tech4good/public/projects/mrm/mrm-app1.png`.
